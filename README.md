...
<p align="justify"> 
Let’s understand this conceptually by using the a example. We want to find the 1500 most commonly used words in a text file. A possible solution is showed in Figure 7:
</p>
